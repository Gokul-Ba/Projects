...
namespace CurrencyConverter
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void BtnOK_Click(object sender, EventArgs e)
        {
            ...
            //The most important factor is that double, being implemented as a binary fraction, 
            //cannot accurately represent many decimal fractions(like 0.1) at all ... leading to rounding errors
            //and its overall number of digits is smaller since it is 64 - bit wide vs. 128 - bit for decimal.
